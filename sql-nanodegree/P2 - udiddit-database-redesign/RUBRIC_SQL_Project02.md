---
title: "SQL"
source: "https://learn.udacity.com/nd072?version=4.0.1&partKey=cd0362&lessonKey=ls1958&project=rubric"
author:
published:
created: 2026-02-04
description:
...
| --- | --- |
| Is the SQL code syntax-highlighted? | All SQL code submitted should be properly syntax highlighted in order to make it easier to read.  See [this StackOverflow post (opens in a new tab)](https://webapps.stackexchange.com/questions/19241/how-can-i-get-code-syntax-highlighting-in-google-docs) for some tips on how to do so. |
...
| Is the provided data model consistent? |  |
...
|  | - Each username has to be unique - Usernames can be composed of at most 25 characters - Usernames can’t be empty - We won’t worry about user passwords for this project |
|  | - Topic names have to be unique. - The topic’s name is at most 30 characters - The topic’s name can’t be empty - Topics can have an optional description of at most 500 characters. |
|  | - Posts have a required title of at most 100 characters - The title of a post can’t be empty. - Posts should contain either a URL or a text content, but not both. - If a topic gets deleted, all the posts associated with it should be automatically deleted too. - If the user who created the post gets deleted, then the post will remain, but it will become dissociated from that user. |
|  |  |
